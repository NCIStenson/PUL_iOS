...
@interface ZENewSearchQuestionVC ()<ZENewSearchQuestionViewDelegate>
{
    ZENewSearchQuestionView * _questionsView;
...
@implementation ZENewSearchQuestionVC
...
-(void)initView
{
    _questionsView = [[ZENewSearchQuestionView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT ) withEnterType:_showQuestionListType];
...
{
    _showQuestionListType = QUESTION_LIST_NEW;
...
-(void)goTypeSearchWithTypeCode:(NSString *)typeCode withParentCode:(NSString *)parentCode
{
    _showQuestionListType = QUESTION_LIST_TYPE;
    
    self.typeSEQKEY = typeCode;
    self.typeParentID = parentCode;
